...
import { Upload, Camera, Loader2, Check, X, School, User, Mail, Phone, Lock, Users } from "lucide-react"
    ...
    return (
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl  mt-5 w-full mx-auto p-8 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              ${isDirty && !isLoading ? "bg-indigo-600 hover:bg-indigo-700" : "bg-gray-400  cursor-not-allowed"
                            } transition-colors`}
                    >
                        {isLoading ? (
                            <>
