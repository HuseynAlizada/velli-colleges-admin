...
const PlacementTestGrade = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setIsLoading(true)
      try {
        const { data, error } = await supabase.from("placement_test_results").select("*")
      ...
      <div className="max-w-7xl mx-auto py-2">
        <div className="w-full max-w-7xl mx-auto p-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
            <div>
              <h2 className="text-2xl font-bold text-gray-800">Placement Test Results</h2>
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        <div>
                          ...
                          <p className="text-gray-500 text-sm">Exam Name: Placement Test</p>
                        </div>
