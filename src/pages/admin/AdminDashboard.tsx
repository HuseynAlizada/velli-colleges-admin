...
//     useEffect(() => {
//         // Removed setLoading(true) as loading state is no longer used
//         fetchStudents()
//         // Removed setLoading(false) as loading state is no longer used
//     }, [])
...
interface Student {
    ...
    email: string;
    phone: string;
    level: Level; // Updated to use Level type
    parent_name: string;
    parent_phone: string;
    image_url: string;
}
...
export default function AdminDashboard() {
    ...
    const getLevelColor = (level: string): string => {
        ...
        return colors[level.toLowerCase() as Level] || "bg-gray-50 text-gray-700 ring-gray-600/20";
    };
