...
//     const [grades, setGrades] = useState<studentGrade[] | null>(null)
...
const StudentGrade = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-10 w-full">
                ...
                <div className="w-full max-w-7xl mx-auto p-6">
                    ...
                    {!isLoading && (!results || results.length === 0) && (
                        <div className="flex flex-col items-center justify-center py-12 bg-white rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-500 max-w-md text-center">
                                There are no exam results available at the moment. Check back later or try a different search.
                            </p>
                        </div>
                    )}
                                    ...
                                    >
                                        <div className="p-6">
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                                    <h3 className="text-lg font-semibold text-gray-900 line-clamp-1">{result.student_name}</h3>
                                                    <p className="text-gray-500 text-sm">Exam Name: {result.exam_name}</p>
                                                </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="h-3 w-full bg-gray-100 rounded-full overflow-hidden">
                                                    <div
                                                        className={`h-full rounded-full bg-gradient-to-r ${getScoreColor(result.student_score)}`}
                    ...
                    {!isLoading && results && results.length > 0 && filteredResults.length === 0 && (
                        <div className="flex flex-col items-center justify-center py-12 bg-white rounded-xl shadow-sm">
                            ...
                            <p className="text-gray-500 max-w-md text-center">
                                No results match your current search or filter criteria. Try adjusting your filters or search term.
                            </p>
                            <button
                                onClick={() => {
                                    setSearchTerm("")
