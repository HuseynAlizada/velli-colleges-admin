...
export default function PracticeExamQuestions() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (studentError) throw new Error("Failed to fetch student level: " + studentError.message);
            ...
            if (fetchError) throw new Error("Failed to fetch current exam count: " + fetchError.message);
            ...
            if (updateError) throw new Error("Failed to update exam count: " + updateError.message);
        ...
        <div className="min-h-screen bg-gradient-to-br w-full select-none">
            ...
            <div className="question-header mt-12 relative">
                <div className="text-center mb-12">
                    ...
                    </p> <p className="text-white     text-xl">
                        Good Luck
                    </p>
                </div>
            </div>
                                        ...
                                        <div className="mb-6 bg-white rounded-2xl p-8 shadow-md">
                                            {contentType === "audio" && (
                                                <>
                                                    ...
                                                    <audio controls className="w-full max-w-md mx-auto">
                                                        <source src={firstQuestion.content} type="audio/mpeg" />
                                            ...
                                            {contentType === "video" && (
                                                <>
                                                    ...
                                                    <video controls className="w-full max-w-md mx-auto">
                                                        <source src={firstQuestion.content} type="video/mp4" />
                                            ...
                                            {contentType === "text" && (
                                                <>
                                                    ...
                                                    <p className="text-gray-700">{firstQuestion.content}</p>
                                                </>
                                            )}
                                        </div>
                                    )}
