...
// //     const [timeLeft, setTimeLeft] = useState(60 * 60); // 1 hour in seconds (60 minutes * 60 seconds)
...
// //         } catch (err) {
// //             console.error(err);
// //             toast.error("Failed to update exam count. Please try again.");
// //             setIsModalOpen(true); // Still open modal to show score even if Supabase update fails
// //         }
// //     };
...
// //              {/* Sticky Timer at Bottom of question-header */}
// //              {!isSubmitted && (
// //                     <div className="fixed top-20 right-0 z-10 bg-white shadow-md p-4 text-center">
...
//         try {
//             // Fetch student_level from students table (adjust table/column names as needed)
...
//             const studentLevel = studentData?.level || "Unknown"; // Default to "Unknown" if not found
//             console.log(studentData, 'studentData')
//             const studentName = studentData?.name || "Unknown"; // Default to "Unknown" if not found
...
//                     exam_name: exam?.title || "Unnamed Exam", // Use exam title as exam_name
...
//             setIsModalOpen(true); // Open modal even if there's an error to show the score
//         }
//     };
