...
//             </h1>
//             <p className="text-gray-600 max-w-md">
//               It looks like there are no placement tests assigned to you at the
//               moment. Please check back later or contact your instructor.
//             </p>
//           </div>
//         </div>
//       )}

//       {/* ✅ Moved outside the first ternary */}
//       <h1 className="text-2xl text-center py-5">Approved Placement Test</h1>
